...
QT_MOC_LITERAL(5, 67, 23) // "on_pushButton_2_clicked"
    ...
    "Journal\0send_status\0\0on_pushButton_3_clicked\0"
...
void Journal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Journal::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Journal::send_status)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Journal::send_status(QString _t1)
{
